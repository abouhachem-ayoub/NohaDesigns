...
const ProductPhotoGallery:FC<{photos: ImageType[]} > = ({photos}) => {
        ...
        <div className="grid md:grid-cols-2 relative gap-5 px-3">
            <div className="h-[540px] relative rounded-2xl overflow-hidden">
                <div className="hidden md:flex justify-center items-center w-full h-full ">
                        ...
                        alt={`Product photo ${currentPhotoIndex}`}
                        width={150}
                        height={150}
            ...
            <div className="hidden md:grid grid-cols-2 h-full gap-5">
                ...
                {remainingPhotosCount > 0 && <div className="cursor-pointer relative h-64 rounded-2xl overflow-hidden "
                                            onClick={openModal.bind(this,maximumVisiblePhotos)}>
                                                <Image src={photos[maximumVisiblePhotos-1].url} alt={`Product photo ${maximumVisiblePhotos}`} width={150} height={150} className="img"/>
            ...
            {showModal && 
                <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-90 z[100]">
